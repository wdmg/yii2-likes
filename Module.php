...
class Module extends \yii\base\Module
{
    ...
    public function init()
    {
        ...
        if (Yii::$app instanceof \yii\console\Application)
            $this->controllerNamespace = 'wdmg\likes\commands';
    ...
    {
        Yii::$app->i18n->translations['app/modules/likes'] = [
            'class' => 'yii\i18n\PhpMessageSource',
            'sourceLanguage' => 'en-US',
            'basePath' => '@vendor/wdmg/yii2-likes/messages',
        ...
        $this->name = Yii::t('app/modules/likes', $this->name);
        $this->description = Yii::t('app/modules/likes', $this->description);
    }

    public static function t($category, $message, $params = [], $language = null)
    {
        return Yii::t('app/modules/likes' . $category, $message, $params, $language);
    }
    ...
    public function dashboardNavItems()
    {
        return [
            'label' => $this->name,
            'url' => [$this->routePrefix . '/likes/'],
            'active' => in_array(\Yii::$app->controller->module->id, ['likes'])
        ];
    }
}